...
// says which shop the caller wants: every call is filed under the mechanical
// shop. The Lead's own shopType is what gets corrected in the CRM once someone
// actually talks to the customer.
export const CALL_SHOP_TYPE = 'mechanical'
