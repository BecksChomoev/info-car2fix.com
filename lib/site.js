...
// Main business line — rings the Newark mechanical shop. Used for site-wide
// CTAs (navbar, footer, homepage, service/location pages, contact form). The
// Linden body shop has its own line below in BODY_SHOP.phone.
export const PHONE = {
...
export const BODY_SHOP = {
  ...
  path: '/body-shop',
  // Dedicated line for the Linden body shop (distinct from the main PHONE).
  phone: {
    display: '(908) 525-3681',
    href: 'tel:9085253681',
    e164: '+1-908-525-3681',
  },
