...
// One page of the call-log sync feed. First run: FSync seeded with the last 7
// days. After that: ISync with the stored token returns only changes. If more
// than 250 changes accumulate between runs RingCentral rejects the ISync —
