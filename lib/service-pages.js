...
// ASE-certified technicians, Newark shop at
...
export const servicePages = [
  {
    ...
    description:
      'Brake repair in Newark, NJ by ASE-certified technicians. Pads, rotors, calipers & brake fluid. Free estimates. (607) 251-1509.',
    intro:
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          'Most brake pads last 30,000–70,000 miles depending on your driving and the pad type, and city driving or hard braking wears them faster. We measure your pads during any service and tell you honestly how much life is left.',
      },
      {
  ...
  },
  {
    ...
    included: [
      ...
      { title: 'Compressor & Condenser Repair', text: 'Failed compressors and condensers replaced with quality parts to restore cold air.' },
  ...
  },
  {
    ...
    faqs: [
      ...
      {
        question:
          'Can you fix an overheating car the same day?',
        answer:
          'Often, yes — a thermostat, hose, or coolant leak can usually be handled the same day, while a water pump or radiator replacement may take longer. Our ASE-certified technicians serve drivers across Newark, Elizabeth, Hillside, Irvington, and Union, and we give you a clear timeline with your free estimate.',
      },
    ],
  ...
  },
  {
    ...
    description:
      'Fuel system repair in Newark, NJ by ASE-certified techs. Pumps, injectors, filters & pressure testing. Free estimates. (607) 251-1509.',
    intro:
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          'A fuel filter is often under an hour, while a fuel pump replacement usually takes a few hours since the tank frequently has to come down. Every job is done by ASE-certified technicians, and you get a free written estimate before we start. Call our Newark shop at (607) 251-1509.',
      },
    ],
...
export const locationPages = [
  ...
  },
  {
    ...
    intro:
      'Our certified body shop is right here in Linden at 1420 E Elizabeth Ave — collision repair, painting, and dent removal. For mechanical work, our Newark shop is a quick drive up Routes 1&9.',
    proximity: {
    ...
    faqs: [
      {
        ...
        answer:
          'Yes — our auto body shop is at 1420 E Elizabeth Ave, Linden, NJ 07036, open Mon–Fri 8am–6pm. It handles collision repair, painting, dent removal, and all body work.',
      },
      {
        question: 'Where do Linden drivers go for mechanical repairs?',
        answer:
          'Our mechanical shop at 408 Carnegie Ave in Newark — about a 15-minute drive up Routes 1&9. Engine, transmission, brakes, oil changes, and everything in between.',
      },
      {
  ...
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          'Yes — estimates are free at both our Newark mechanical shop and our Linden body shop. For collision work we can also work directly with your insurance company.',
      },
    ],
  },
]
...
export const bodyServicePages = [
  {
    ...
    description:
      'Collision repair in Linden, NJ by I-CAR & OEM-certified techs. Frame measuring, OEM parts, paint blending, insurance claims handled. (607) 251-1509.',
    intro:
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          'It depends on the damage — minor cosmetic work can be a few days, while major structural repairs can take a couple of weeks, especially when parts are on order. We keep you updated and give you a realistic timeline with your free estimate.',
      },
    ],
  ...
  },
  {
    ...
    description:
      'Auto body painting in Linden, NJ by I-CAR & OEM-certified techs. Color matching & clear-coat refinishing. Free estimates. (607) 251-1509.',
    intro:
    ...
    faqs: [
      ...
      {
        question:
          'Can you repaint just one panel instead of the whole car?',
        answer:
          'Usually, yes. When the damage is limited to one area, we can refinish that panel and blend the color into the surrounding paint so the repair is seamless, which keeps the cost down versus a full repaint.',
      },
    ],
  ...
  },
  {
    ...
    description:
      'Dent removal in Linden, NJ by I-CAR & OEM-certified techs. Paintless dent repair for door dings & hail, plus filler & refinish. Free estimates. (607) 251-1509.',
    intro:
    ...
    faqs: [
      ...
      {
        question:
          'Will removing the dent affect my paint?',
        answer:
          'With paintless dent repair, no — your original factory paint stays untouched. For larger dents that need filler, we color-match and refinish the panel so the repair blends into your existing paint.',
      },
    ],
  ...
  },
  {
    ...
    description:
      'Frame straightening in Linden, NJ. Computerized measuring & hydraulic pulling back to factory spec. I-CAR certified, insurance handled. (607) 251-1509.',
    intro:
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          'It is risky. A misaligned frame throws off your steering and tire wear and reduces the crash protection engineered into the car. Our I-CAR and OEM-certified technicians document the before-and-after measurements so you have proof the frame is back within factory tolerance.',
      },
    ],
  ...
  },
  {
    ...
    description:
      'Scratch & scuff repair in Linden, NJ. I-CAR certified techs buff out clear-coat scratches, color-match & refinish deep ones. Free estimates. (607) 251-1509.',
    intro:
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          'Yes. We pull your factory paint code and blend the color into the surrounding finish so the repair is invisible. Our I-CAR and OEM-certified technicians do this work daily, so the repair disappears into your existing paint.',
      },
      {
        question:
  ...
  },
  {
    ...
    description:
      'Windshield replacement in Linden, NJ with OEM-quality glass, urethane sealing & ADAS recalibration. Free written estimate, insurance handled. (607) 251-1509.',
    intro:
  ...
  },
  {
    ...
    description:
      'Body panel replacement in Linden, NJ by I-CAR & OEM-certified techs. Fenders, doors, hoods & quarter panels. Free estimates. (607) 251-1509.',
    intro:
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          'Yes. Our OEM-certified technicians refinish and blend each new panel to your existing paint so the repair isn\'t visible from the driveway.',
      },
      {
        question:
  ...
  },
  {
    ...
    description:
      'Bumper crack, scuff & sensor repair in Linden, NJ by I-CAR & OEM-certified techs. Color-matched paint, free estimate. (607) 251-1509.',
    intro:
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          'Yes. We use computerized paint matching to blend the repair with your vehicle\'s factory color, so the bumper doesn\'t look off.',
      },
      {
        question:
  ...
  {
    slug: 'color-matching-linden-nj',
    shop: 'body',
    name: 'Color Matching',
    icon: 'ScanLine',
    h1: 'Color Matching in Linden, NJ',
    title: 'Color Matching in Linden, NJ | Car2Fix Body Shop',
    description:
      'Paint color matching in Linden, NJ by I-CAR & OEM-certified techs. Spectrophotometer scan, custom-mixed & blended paint. Free written estimate. (607) 251-1509.',
    intro:
      'Got a replaced bumper that\'s a shade off, or paint faded by the sun that won\'t match a fresh part? At our Linden shop, our I-CAR and OEM-certified technicians read your factory paint code, scan the actual finish, and custom-mix the exact shade to blend it in — with a free written estimate before any work begins.',
    includedHeading: 'What\'s Included in Our Color Matching Service',
    included: [
      { title: 'Factory Paint Code Reading', text: 'We pull your exact factory paint code from the VIN or door-jamb tag as the true starting point for the mix.' },
      { title: 'Spectrophotometer Scan', text: 'We scan your actual finish so the mix accounts for real fade and weathering, not just the code on paper.' },
      { title: 'Custom In-House Mixing', text: 'The exact shade is mixed in-house and sprayed on a test card before it ever touches your car.' },
      { title: 'Faded Finish Matching', text: 'Older, sun-faded paint matched to how it looks today so a new spot doesn\'t sit bright against it.' },
      { title: 'Blending Into Adjacent Panels', text: 'We fade the fresh paint into the surrounding panels so there\'s no hard line where the repair ends.' },
      { title: 'Partial & Insurance Matching', text: 'Color matched on spot and insurance repairs, with the whole claims process handled for you.' },
    ],
    signsHeading: 'Signs You Need Color Matching',
    signs: [
      'A replaced bumper or panel that\'s a slightly different shade than the rest of the car',
      'A spot repair that looks brighter or \'off\' against your older, faded paint',
      'Sun-faded paint that no longer matches a freshly painted or brand-new part',
      'Touch-up paint mixed from the code that looks wrong once it dries',
      'Two panels that should match but clearly don\'t in daylight',
    ],
    faqs: [
      {
        question:
          'How much does paint color matching cost in Linden, NJ?',
        answer:
          'Color matching is usually part of a spot or panel repair rather than billed on its own. As a standalone blend on one area, expect roughly $150–$500 depending on the color and how many panels need blending; metallics and pearls take more work than solid colors. You get a free written estimate before any work begins.',
      },
      {
        question:
          'Why doesn\'t the factory paint code alone match my car?',
        answer:
          'Because paint fades and shifts with sun and age, so the original code rarely matches a five- or ten-year-old finish exactly. We scan your actual paint with a spectrophotometer and custom-mix to what your car looks like now, then blend it into the surrounding panels.',
      },
      {
        question:
          'Can you match faded paint without repainting the whole car?',
        answer:
          'Yes — that\'s the whole point of color matching. We mix to your current, faded finish and blend into the adjacent panels so a spot or partial repair doesn\'t stand out. A full repaint is only needed when the finish is failing across the entire vehicle, and we\'ll tell you honestly if it isn\'t.',
      },
      {
        question:
          'My insurance is paying for a partial repair — will the paint still match?',
        answer:
          'Yes. On partial and insurance repairs we color-match and blend into the neighboring panels so the fixed area isn\'t obvious. We handle the entire claims process and work with all major insurers, including GEICO, State Farm, Progressive, Allstate, Liberty Mutual, and USAA.',
      },
      {
        question:
          'How long does color matching take at your Linden body shop?',
        answer:
          'The match itself — reading the code, scanning, mixing, and spraying a test card — is usually done in a day, while the full spot repair with blending and cure time typically runs 1–3 days. We give you an exact timeline with your free written estimate, and we serve drivers across Linden, Elizabeth, Rahway, Roselle, and Union.',
      },
    ],
    related: ['auto-body-painting-linden-nj', 'scratch-repair-linden-nj', 'collision-repair-linden-nj'],
  },
  {
    slug: 'fiberglass-repair-linden-nj',
    shop: 'body',
    name: 'Fiberglass Repair',
    icon: 'Dices',
    h1: 'Fiberglass Repair in Linden, NJ',
    title: 'Fiberglass Repair in Linden, NJ | Car2Fix Body Shop',
    description:
      'Fiberglass & composite repair in Linden, NJ by I-CAR & OEM-certified techs. Cracks, holes & delamination fixed, color-matched. Free estimate. (607) 251-1509.',
    intro:
      'Cracked spoiler, a split body kit, or a fiberglass panel starting to bubble and delaminate? Our I-CAR and OEM-certified technicians rebuild fiberglass and composite parts with resin, matting, and gelcoat at our Linden, NJ body shop — with a free written estimate before any work begins.',
    includedHeading: 'What\'s Included in Our Fiberglass Repair Service',
    included: [
      { title: 'Repair vs. Replace Assessment', text: 'An honest look at whether the cracking, holes, or delamination can be repaired — and when repair beats sourcing a hard-to-find replacement panel.' },
      { title: 'Crack & Hole Repair', text: 'Cracks, gouges, and stress fractures rebuilt from behind with resin and fiberglass matting for real structural strength, not just cosmetic filler.' },
      { title: 'Delamination Repair', text: 'Separated, lifting, or bubbling layers ground out, re-bonded, and rebuilt so the panel is solid again.' },
      { title: 'Reshaping & Filler', text: 'Body filler and careful sanding to bring spoilers, ground effects, and body-kit panels back to their original contour.' },
      { title: 'Gelcoat & Color-Matched Refinishing', text: 'Sanded, primed, and finished with gelcoat and careful color matching so the repair blends into the rest of the car.' },
      { title: 'Free Written Estimate', text: 'A clear, itemized quote before any work begins — and we handle the insurance claim if one\'s involved.' },
    ],
    signsHeading: 'Signs You Need Fiberglass Repair in Linden, NJ',
    signs: [
      'Cracks or star fractures spreading across a spoiler, body kit, or ground effects',
      'A hole, gouge, or punch-through in a fiberglass or composite panel',
      'Bubbling, lifting, or soft spots where the fiberglass layers have started to delaminate',
      'Spider cracking in the paint or gelcoat over a stressed fiberglass area',
      'An older or specialty car — like a Corvette — with a panel that\'s hard to source or expensive to replace',
    ],
    faqs: [
      {
        question:
          'How much does fiberglass repair cost in Linden, NJ?',
        answer:
          'Most fiberglass repairs run $250-$800 depending on the size of the crack or hole, how much reshaping the panel needs, and the refinishing involved; large structural rebuilds cost more. We provide a free written estimate before any work begins so there are no surprises.',
      },
      {
        question:
          'Is it better to repair fiberglass or replace the whole panel?',
        answer:
          'For most cracks, holes, and delamination, a proper resin-and-mat repair is strong and far cheaper than replacement — especially on older or specialty cars where the panel is hard to find or expensive to buy. If a part is shattered beyond rebuilding, we\'ll tell you honestly when replacement is the better call.',
      },
      {
        question:
          'Can you repair fiberglass on a Corvette or a custom body kit?',
        answer:
          'Yes. We rebuild fiberglass and composite spoilers, ground effects, body kits, and specialty-car panels, including fiberglass-bodied cars like the Corvette. Our I-CAR and OEM-certified technicians assess the damage first and walk you through the repair before touching anything.',
      },
      {
        question:
          'Will the repaired fiberglass match the rest of my car?',
        answer:
          'Yes. After the structural repair we sand, prime, and refinish the area, then carefully color-match to your factory paint so the fix doesn\'t stand out.',
      },
      {
        question:
          'Does insurance cover fiberglass repair, and can you handle the claim?',
        answer:
          'If the damage came from a covered incident, it often is. We handle the entire claims process and work with all major insurers, including GEICO, State Farm, Progressive, Allstate, Liberty Mutual, and USAA — and we take in fiberglass and composite work from across Linden, Elizabeth, Rahway, Roselle, and Union.',
      },
    ],
    related: ['body-panel-replacement-linden-nj', 'bumper-repair-linden-nj', 'collision-repair-linden-nj'],
  },
  {
    slug: 'headlight-restoration-linden-nj',
    shop: 'body',
    name: 'Headlight Restoration',
    icon: 'CircleDot',
    h1: 'Headlight Restoration in Linden, NJ',
    title: 'Headlight Restoration in Linden, NJ | Car2Fix Body Shop',
    description:
      'Headlight restoration in Linden, NJ by I-CAR & OEM-certified techs. Clear up cloudy, yellowed lenses for safer night driving. Free estimate. (607) 251-1509.',
    intro:
      'Foggy, yellowed headlights that barely light the road at night — and might get flagged at inspection? Our I-CAR and OEM-certified technicians wet-sand, polish, and re-seal cloudy lenses on all makes and models at our Linden, NJ body shop, with a free written estimate before any work begins.',
    includedHeading: 'What\'s Included in Our Linden Headlight Restoration Service',
    included: [
      { title: 'Lens Condition Assessment', text: 'An honest look at whether your lenses can be restored or whether a cracked, internally-fogged housing truly needs replacing.' },
      { title: 'Wet-Sanding', text: 'The hazed, oxidized outer layer of the lens carefully wet-sanded away through progressively finer grits.' },
      { title: 'Machine Polishing & Buffing', text: 'The sanded lens machine-polished and buffed back to a clear, smooth finish.' },
      { title: 'UV Clear-Coat Sealing', text: 'A protective UV clear coat sealed over the lens so it resists yellowing and stays clear far longer than a quick buff alone.' },
      { title: 'Both Headlights Matched', text: 'We restore both lenses so they match, instead of leaving one noticeably clearer than the other.' },
      { title: 'Free Written Estimate', text: 'A clear, itemized quote before any work begins — and if the damage ties into a larger claim, we can handle the insurance side too.' },
    ],
    signsHeading: 'Signs You Need Headlight Restoration in Linden, NJ',
    signs: [
      'Headlights look cloudy, yellow, or milky in daylight',
      'Weak, dim light on the road at night even with good bulbs',
      'A chalky, rough, or filmy texture on the lens surface',
      'One lens is noticeably hazier than the other',
      'Your headlight visibility was flagged at a recent NJ inspection',
    ],
    faqs: [
      {
        question:
          'How much does headlight restoration cost in Linden, NJ?',
        answer:
          'Restoring a pair of oxidized headlights typically runs about $75-$150 depending on how badly hazed the lenses are and how much sanding they need — far cheaper than replacing the housings, which can run several hundred dollars each. We give you a free written estimate before any work begins.',
      },
      {
        question:
          'Will cloudy headlights fail NJ inspection?',
        answer:
          'Badly yellowed or oxidized lenses cut down how much light reaches the road and can be flagged as a visibility issue. Restoration clears the lens so your headlights put out proper light again — a real safety fix, not just a cosmetic one. Come by our Linden shop and we\'ll assess them for free; we regularly restore headlights for drivers from Linden, Elizabeth, Rahway, Roselle, and Union.',
      },
      {
        question:
          'How long will the headlights stay clear after restoration?',
        answer:
          'We finish with a UV-protective clear coat, which helps the lenses stay clear much longer than a simple buff that skips the sealing step. Sun and weather do eventually take their toll over time, and if the haze ever returns we can re-treat them — we\'ll always be upfront about what to expect.',
      },
      {
        question:
          'Can you restore any headlight, or will I need new ones?',
        answer:
          'If the cloudiness is surface oxidation on the outside of the lens, restoration almost always brings it back. If the housing is cracked, fogged with moisture on the inside, or the reflector is damaged, sanding won\'t fix that and replacement is the honest call — we\'ll tell you which one you\'re dealing with before you spend a dime.',
      },
      {
        question:
          'How long does headlight restoration take?',
        answer:
          'Most headlight restorations are done in about an hour and finished the same day, so you usually won\'t be without your car for long. If we spot a housing that needs replacing instead, we\'ll give you a clear timeline and estimate first.',
      },
    ],
    related: ['scratch-repair-linden-nj', 'auto-body-painting-linden-nj', 'bumper-repair-linden-nj'],
  },
