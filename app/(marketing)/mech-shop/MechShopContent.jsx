...
const services = [
  ...
  { icon: Thermometer, title: 'Cooling System', description: 'Radiator repair, coolant flush, thermostat replacement, and leak repairs.', href: '/cooling-system-repair-newark-nj' },
  ...
  { icon: Fuel, title: 'Fuel System', description: 'Fuel pump, fuel injector, and fuel filter services and repairs.', href: '/fuel-system-repair-newark-nj' },
